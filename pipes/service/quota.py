...
from pipes.context.factory import ContextPoolFactory, LazyContext
...
class Quota(IQuota):
    ...
    def __init__(self, quota_name, rate_counter, limit, threshold):
        ...
        :type rate_counter: pipes.service.rate_counter.IRateCounter
...
def quota_pool_factory(config, rate_counter):
    ...
    :type rate_counter: IContextPool[pipes.service.rate_counter.IRateCounter]
