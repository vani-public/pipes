...
from pipes.context.config import client_config
from pipes.service import key
from pipes.service.base import ComplexKey, MemcachedComplexKey
from pipes.service.base_client import RedisClient, MemcachedClient, get_redis_client, \
    get_memcached_client
from pipes.service.hash import IHash

from pipes.context.factory import ContextPoolFactory, LazyContextPoolFactory
...
class MemcachedCache(MemcachedClient, ComplexKey, ICache):
    ...
    def get_many(self, keys, default=None):
        formatted_keys = map(self.format_key, keys)
