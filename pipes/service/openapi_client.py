...
from pipes.service.http_client import HttpClient, extract_api_name

from pipes.context.factory import LazyContextPoolFactory
...
def create_client(url,
    ...
    :type cache: pipes.service.cache.ICache
...
def configure_api_client_factory(api_name, config, cache=None, metrics=None):
    ...
    :type config: pipes.config import Config
    :type metrics: pipes.service.metric.IMetrics
