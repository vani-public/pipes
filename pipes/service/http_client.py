...
from pipes.context.factory import LazyContext, LazyContextPoolFactory
from pipes.exceptions import ExtendedException
...
def create_http_client(http_client_name=None, metrics=None, cache=None, config=None):
    ...
    :type metrics: pipes.service.metric.IMetrics
    :type cache: pipes.context.pool.IContextPool[ICache]
    :type config: pipes.config.Config
