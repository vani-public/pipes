from pipes.context import apply_context_to_kwargs, context
from pipes.context.lock import suspended_guard
from pipes.context.manager import pipe_contextmanager
from pipes.exceptions import RateLimitExceededException
...
def quota_guard(quota_name=None, suspend=True,
    ...
    def quota_guard_contextmanager(injections, quota=None):
        """
        :type injections: pipes.context.LazyContextCollection
        :type quota: pipes.context.pool.IContextPool[pipes.service.quota.IQuota]
        :raise: pipes.exceptions.QuotaExceededException
        """
        if quota:
...
:type rate_counter: pipes.context.pool.IContextPool[pipes.service.rate_counter.IRateCounter]
        :type injections: pipes.context.LazyContextCollection
        """
