...
from pipes.context import apply_context_to_kwargs, injections_handler
from pipes.context.manager import pipe_contextmanager
from pipes.exceptions import DropMessageException, RetryMessageException
from pipes.service import key

from pipes.context.factory import lazy_context
...
def cache(expires_in=None, **context_kwargs):
    ...
    def cache_contextmanager(message, processor_id, response, injections, cache):
        ...
        :type cache: pipes.context.pool.IContextPool[pipes.service.cache.ICache]
        """
        cache_client = cache.processor  # type: pipes.service.cache.ICache
...
def cached_lazy_context(_gen_func=None, expires_in=None, generation_time=5,
    ...
    :rtype: pipes.context.factory.LazyContext
    """
    ...
    def _cached_lazy_context(cache, lock, injections):
        ...
        """
        context_cache = cache.context  # type: ICache
        context_lock = lock.context  # type: ILock
