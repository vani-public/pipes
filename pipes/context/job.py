...
from pipes.context.lock import singleton_guard
from pipes.context.manager import pipe_contextmanager
from pipes.exceptions import DropMessageException
from pipes.processor import event_processor, pipe_processor
...
class Job(object):
    ...
    def job_guard(self):
        ...
        def _job_guard(message, response, lock):
            ...
            :type lock: pipes.context.pool.IContextPool[pipes.service.lock.ILock]
            :param injections:
            :return:
            """
