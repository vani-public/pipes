...
from pipes.exceptions import RetryMessageException, DropMessageException, RetryException
...
class Locker(object):
    def __init__(self, lock_service, lock_key, expire_in=None):
        ...
        :type lock_service: pipes.service.lock.ILock
...
def locker(lock_name=None, expire_in=DEFAULT_LOCK_EXPIRATION, lock_category='default',
    ...
    :rtype: pipes.context.manager.PipeContextManager
    """
    @pipe_contextmanager
