...
from pipes.context import ContextPath, apply_context_to_kwargs, LazyContextCollection
from pipes.events import EVENT_START, EVENT_STOP
from pipes.exceptions import RetryMessageException, DropMessageException, ExtendedException
from pipes.infrastructure.response.listener import ListenerResponseHandler
from pipes.message import FrozenMessage
...
class Infrastructure(object):
    ...
    def process_message(self, program, processor_id, message_dict):
        ...
        :param program: Program object
        :type program: pipes.program.Program
