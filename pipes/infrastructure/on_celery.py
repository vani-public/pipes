...
from pipes.infrastructure.base import ListenerInfrastructure, ISchedulerCommands
...
class BaseCeleryInf(ListenerInfrastructure):
    ...
    def program_lock(self):
        ...
        :return: lock service
        :rtype: pipes.service.lock.ILock
        """
...
class CelerySchedulerMixIn(ISchedulerCommands):
    ...
    def scheduler_storage(self):
        ...
        :rtype: pipes.service.storage.IStorage
        """
